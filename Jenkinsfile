node {
   ...
   {
              stage('ENv preparing...') {
        sh 'ssh -p 22 omar@192.168.1.4 "rm -rf /home/sama/addons/*" '
      
                    }
       
       stage ('Addons Install..'){
                 sh 'ssh -p 22 omar@192.168.1.4 "cd /home/sama/addons/ ; git clone --branch dev  https://github.com/moussiomar90/odoo.git  ./openacademy;" '
              }
         stage ('Test ok '){
